...
export const uploadImage = async (url, formData, params) => {
    try {
        const data = await axios.post(`${baseUrl}${url}`, formData, params);
        return data;
    } catch (error) {
        return error;
    }
 ...
 * @returns 
 */
export const flame = async (url, formData, params) => {
    try {
        const data = await axios.post(`${baseUrl}${url}`, formData, params);
        return data;
    } catch (error) {
...
export const smoke = async (url, formData, params) => {
    try {
        const data = await axios.post(`${baseUrl}${url}`, formData, params);
        return data;
    } catch (error) {
...
export const recover = async (url, formData, params) => {
    try {
        const data = await axios.post(`${baseUrl}${url}`, formData, params);
        return data;
    } catch (error) {
