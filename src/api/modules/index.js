...
export const uploadImage = (url,formData,param) => {
    return API.uploadImage(url,formData,param)
}

export const flame = (url,formData,param) => {
    return API.flame(url,formData,param)
}
export const recover = (url,formData,param) => {
    return API.recover(url,formData,param)
}

export const smoke = (url,formData,param) => {
    return API.smoke(url,formData,param)
}
