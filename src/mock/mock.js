            ...
            "list|20": [
                {
                    ...
                    createTime() {
                        ...
                        const start = new Date(now.getFullYear(), now.getMonth(), 1) // 本月 1 日 00:00:00

                        // 随机时间戳
                        const stamp = Mock.Random.integer(start.getTime(), now.getTime())
                        const d = new Date(stamp)

                        // 手动格式化成 yyyy-MM-dd HH:mm:ss
            ...
            "list|40": [
                {
                    ...
                    provinceName: '北京市',
                    cityName: '北京市',
                    countyName() { return Mock.Random.pick(beijingCounties) }
                }
            ]
        }
    })
