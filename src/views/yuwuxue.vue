...
import HeaderBar from "./yuwuxue/header-bar.vue";
import AlgorithmPanel from "./yuwuxue/algorithm-panel.vue";
import MonitorSection from "./yuwuxue/monitor-section.vue";
// 移除效果对比面板
// import ComparisonPanel from "./yuwuxue/comparison-panel.vue";
import StatusBar from "./yuwuxue/status-bar.vue";
